...
//! (`~/.config/systemd/user/phade-sink.service`). The unit is anchored to
...
const UNIT_NAME: &str = "phade-sink.service";
...
fn render_unit() -> Result<String, SinkError> {
    ...
    Ok(format!(
        "# Generated by Phade Sink. Re-enabling autostart rewrites this file,\n\
         # so the path tracks wherever the binary currently lives.\n\
         [Unit]\n\
         Description=Phade Sink audio mixer\n\
